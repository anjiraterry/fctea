    ...
    <div className="min-h-screen bg-[#FFFAF5] flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-[#2D241E] font-montserrat tracking-tight">Welcome back</h1>
          <p className="text-[#2D241E]/50 text-sm font-medium">Log in to your city operating system</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 border border-[#C06350]/10 shadow-sm space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-4 text-[#2D241E]/30 font-bold tracking-widest">Or email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-xs font-bold text-[#2D241E]/40 uppercase tracking-widest">Password</label>
                <Link href="/auth/reset" className="text-xs font-bold text-[#C06350] hover:underline">Forgot?</Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-sm text-[#2D241E]/40 font-medium">
          ...
          <Link href="/auth/signup" className="text-[#C06350] font-bold hover:underline">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
